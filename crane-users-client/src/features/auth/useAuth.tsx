...
//     if(!context){
//         throw new Error("useAhuth must be used within an AuthProvider");
//     }
//     return context;
// }
...
//         setUser(user);
//         setToken(token);
//         /**store token in localstorage / indexDB / cookie */
//     }

//     const logOut=()=>{
//         setUser(null);
//         setToken(null);
//         /**clear token from localstorage / indexDB / cookie */
//     }

//     const refreshToken = async () => {
//         try {
//             const response = await axios.get('http://localhost:5005/api/user/auth',{
...
//     return (
//         <AuthContext value={{isAuthenticated,login,logOut,refreshToken,user,token}}>
//             {children}
//         </AuthContext>
//     )
// }
